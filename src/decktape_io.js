...
var _sixty_north$elm_task_repeater$TaskRepeater$SchedulerRecord = F2(
	function (a, b) {
		return {model: a, next: b};
	});
var _sixty_north$elm_task_repeater$TaskRepeater$ModelRecord = F6(
	function (a, b, c, d, e, f) {
		return {task: a, scheduler: b, onSuccess: c, onError: d, msgWrapper: e, $continue: f};
	});
var _sixty_north$elm_task_repeater$TaskRepeater$Multi = function (a) {
	return {ctor: 'Multi', _0: a};
};
var _sixty_north$elm_task_repeater$TaskRepeater$Execute = {ctor: 'Execute'};
var _sixty_north$elm_task_repeater$TaskRepeater$start = function (model) {
	var _p0 = model;
	return _shmookey$cmd_extra$Cmd_Extra$message(
		_p0._0.msgWrapper(_sixty_north$elm_task_repeater$TaskRepeater$Execute));
};
var _sixty_north$elm_task_repeater$TaskRepeater$Scheduler = function (a) {
	return {ctor: 'Scheduler', _0: a};
};
var _sixty_north$elm_task_repeater$TaskRepeater$scheduler = F2(
	function (model, next) {
		return _sixty_north$elm_task_repeater$TaskRepeater$Scheduler(
			A2(_sixty_north$elm_task_repeater$TaskRepeater$SchedulerRecord, model, next));
	});
var _sixty_north$elm_task_repeater$TaskRepeater$Model = function (a) {
	return {ctor: 'Model', _0: a};
};
var _sixty_north$elm_task_repeater$TaskRepeater$model = F6(
	function (task, scheduler, onResult, onError, msgWrapper, $continue) {
		var _p1 = scheduler;
		return _sixty_north$elm_task_repeater$TaskRepeater$Model(
			A6(_sixty_north$elm_task_repeater$TaskRepeater$ModelRecord, task, _p1._0, onResult, onError, msgWrapper, $continue));
	});
var _sixty_north$elm_task_repeater$TaskRepeater$update = F2(
	function (msg, model) {
		var _p2 = model;
		var _p6 = _p2._0;
		var _p3 = msg;
		if (_p3.ctor === 'Execute') {
			var msgs = function (result) {
				return _p6.$continue(result) ? _elm_lang$core$Native_List.fromArray(
					[
						_p6.onSuccess(result),
						_p6.msgWrapper(_sixty_north$elm_task_repeater$TaskRepeater$Execute)
					]) : _elm_lang$core$Native_List.fromArray(
					[
						_p6.onSuccess(result)
					]);
			};
			var _p4 = _p6.scheduler.next(_p6.scheduler.model);
			var schedulerModel = _p4._0;
			var period = _p4._1;
			var scheduler = A2(_sixty_north$elm_task_repeater$TaskRepeater$SchedulerRecord, schedulerModel, _p6.scheduler.next);
			var task = A2(_NoRedInk$elm_task_extra$Task_Extra$delay, period, _p6.task);
			var cmd = A3(
				_elm_lang$core$Task$perform,
				_p6.onError,
				function (_p5) {
					return _p6.msgWrapper(
						_sixty_north$elm_task_repeater$TaskRepeater$Multi(
							msgs(_p5)));
				},
				task);
			return A2(
				_elm_lang$core$Platform_Cmd_ops['!'],
				_sixty_north$elm_task_repeater$TaskRepeater$Model(
					_elm_lang$core$Native_Utils.update(
						_p6,
						{scheduler: scheduler})),
				_elm_lang$core$Native_List.fromArray(
			...
			return A2(
				_elm_lang$core$Platform_Cmd_ops['!'],
				model,
				A2(_elm_lang$core$List$map, _shmookey$cmd_extra$Cmd_Extra$message, _p3._0));
		}
	});

var _sixty_north$elm_task_repeater$TaskRepeater_Schedulers$uniform = function (period) {
	return A2(
		_sixty_north$elm_task_repeater$TaskRepeater$scheduler,
		period,
		function (last) {
			return {ctor: '_Tuple2', _0: last, _1: last};
		});
};
var _sixty_north$elm_task_repeater$TaskRepeater_Schedulers$ExponentialParams = F3(
	function (a, b, c) {
		return {period: a, factor: b, max: c};
	});
var _sixty_north$elm_task_repeater$TaskRepeater_Schedulers$exponentialBackoff = F3(
	function (period, factor, maxPeriod) {
		var next = function (params) {
			return {
				...
				_0: _elm_lang$core$Native_Utils.update(
					params,
					{
						period: A2(_elm_lang$core$Basics$min, params.period * params.factor, params.max)
					}),
				_1: params.period
			};
		};
		var params = A3(_sixty_north$elm_task_repeater$TaskRepeater_Schedulers$ExponentialParams, period, factor, maxPeriod);
		return A2(_sixty_north$elm_task_repeater$TaskRepeater$scheduler, params, next);
	});

var _toastal$return_optics$Return_Optics$refracto = F4(
	function (o, mergeBack, fx, _p0) {
		var _p1 = _p0;
		var _p3 = _p1._0;
		return A3(
			...
			function (_p2) {
				return A2(
					...
					A3(
						...
						mergeBack,
						A2(_elm_lang$core$Basics$flip, o.set, _p3),
						fx(_p2)));
			},
			o.getOption(_p3));
	});
var _toastal$return_optics$Return_Optics$refractl = F4(
	function (l, mergeBack, fx, _p4) {
		var _p5 = _p4;
		var _p7 = _p5._0;
		return function (_p6) {
			return A2(
				...
				A3(
					_Fresheyeball$elm_return$Return$mapBoth,
					mergeBack,
					A2(_elm_lang$core$Basics$flip, l.set, _p7),
					fx(_p6)));
		}(
			l.get(_p7));
	});

var _user$project$DecktapeIO_Types$StatusLocator = F2(
	function (a, b) {
		return {file_id: a, status_url: b};
	});
var _user$project$DecktapeIO_Types$InProgressDetails = F3(
	function (a, b, c) {
		return {timestamp: a, status_msg: b, locator: c};
	});
var _user$project$DecktapeIO_Types$CompleteDetails = F3(
	function (a, b, c) {
		return {locator: a, timestamp: b, download_url: c};
	});
var _user$project$DecktapeIO_Types$Conversion = F2(
	function (a, b) {
		return {source_url: a, details: b};
	});
var _user$project$DecktapeIO_Types$Suggestion = F4(
	function (a, b, c, d) {
		return {source_url: a, download_url: b, file_id: c, timestamp: d};
	});
var _user$project$DecktapeIO_Types$Error = function (a) {
	return {ctor: 'Error', _0: a};
};
var _user$project$DecktapeIO_Types$Complete = function (a) {
	return {ctor: 'Complete', _0: a};
};
var _user$project$DecktapeIO_Types$InProgress = function (a) {
	return {ctor: 'InProgress', _0: a};
};
var _user$project$DecktapeIO_Types$Initiated = function (a) {
	return {ctor: 'Initiated', _0: a};
};

var _user$project$DecktapeIO_Json$conversionDetailsDecoder = F3(
	function (file_id, status_url, status) {
		var _p0 = status;
		switch (_p0) {
			case 'in-progress':
				return A3(
					...
					A3(
						...
						_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(
							F2(
								function (ts, msg) {
									var locator = A2(_user$project$DecktapeIO_Types$StatusLocator, file_id, status_url);
									var details = A3(_user$project$DecktapeIO_Types$InProgressDetails, ts, msg, locator);
									return _user$project$DecktapeIO_Types$InProgress(details);
								}))));
			case 'complete':
				return A3(
					_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
					...
					A3(
						...
						_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(
							F2(
								function (ts, dl) {
									var locator = A2(_user$project$DecktapeIO_Types$StatusLocator, file_id, status_url);
									var details = A3(_user$project$DecktapeIO_Types$CompleteDetails, locator, ts, dl);
									return _user$project$DecktapeIO_Types$Complete(details);
								}))));
			case 'error':
				return A3(
					_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
					'status_msg',
					_elm_lang$core$Json_Decode$string,
					_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$DecktapeIO_Types$Error));
			default:
				var msg = A2(
					_elm_lang$core$Basics_ops['++'],
					'Unknown status code: ',
					_elm_lang$core$Basics$toString(status));
				var details = _user$project$DecktapeIO_Types$Error(msg);
				return _elm_lang$core$Json_Decode$succeed(details);
		}
	});
var _user$project$DecktapeIO_Json$statusDecoder = F2(
	function (file_id, status_url) {
		return A2(
			_elm_lang$core$Json_Decode$andThen,
			A2(_elm_lang$core$Json_Decode_ops[':='], 'status', _elm_lang$core$Json_Decode$string),
			A2(_user$project$DecktapeIO_Json$conversionDetailsDecoder, file_id, status_url));
	});
var _user$project$DecktapeIO_Json$convertDecoder = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	'status_url',
	_elm_lang$core$Json_Decode$string,
	A3(
		...
		'file_id',
		_elm_lang$core$Json_Decode$string,
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$DecktapeIO_Types$StatusLocator)));
var _user$project$DecktapeIO_Json$suggestionDecoder = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	'timestamp',
	_elm_lang$core$Json_Decode$string,
	A3(
		...
		A3(
			...
			A3(
				...
				'source_url',
				_elm_lang$core$Json_Decode$string,
				_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$DecktapeIO_Types$Suggestion)))));
var _user$project$DecktapeIO_Json$errorToString = function (err) {
	var _p1 = err;
	switch (_p1.ctor) {
...
var _user$project$DecktapeIO_Msg$Poll = F2(
	function (a, b) {
		return {ctor: 'Poll', _0: a, _1: b};
	});
var _user$project$DecktapeIO_Msg$Mdl = function (a) {
	return {ctor: 'Mdl', _0: a};
};
var _user$project$DecktapeIO_Msg$SuggestionsError = F2(
	function (a, b) {
		return {ctor: 'SuggestionsError', _0: a, _1: b};
	});
var _user$project$DecktapeIO_Msg$SuggestionsSuccess = F2(
	function (a, b) {
		return {ctor: 'SuggestionsSuccess', _0: a, _1: b};
	});
var _user$project$DecktapeIO_Msg$StatusError = F2(
	function (a, b) {
		return {ctor: 'StatusError', _0: a, _1: b};
	});
var _user$project$DecktapeIO_Msg$StatusSuccess = F2(
	function (a, b) {
		return {ctor: 'StatusSuccess', _0: a, _1: b};
	});
var _user$project$DecktapeIO_Msg$SubmissionError = F2(
	function (a, b) {
		return {ctor: 'SubmissionError', _0: a, _1: b};
	});
var _user$project$DecktapeIO_Msg$SubmissionSuccess = F2(
	function (a, b) {
		return {ctor: 'SubmissionSuccess', _0: a, _1: b};
	});
var _user$project$DecktapeIO_Msg$SubmitCurrentUrl = {ctor: 'SubmitCurrentUrl'};
var _user$project$DecktapeIO_Msg$SetCurrentUrl = function (a) {
	return {ctor: 'SetCurrentUrl', _0: a};
};

var _user$project$DecktapeIO_Comms$getSuggestions = function (source_url) {
	var url = A2(
		_evancz$elm_http$Http$url,
		'/suggestions',
		_elm_lang$core$Native_List.fromArray(
			[
				{ctor: '_Tuple2', _0: 'url', _1: source_url}
			]));
	var task = A2(
		_evancz$elm_http$Http$get,
		_elm_lang$core$Json_Decode$list(_user$project$DecktapeIO_Json$suggestionDecoder),
		url);
	return A3(
		_elm_lang$core$Task$perform,
		function (_p0) {
			return A2(
				_user$project$DecktapeIO_Msg$SuggestionsError,
				source_url,
				_user$project$DecktapeIO_Json$errorToString(_p0));
		},
		_user$project$DecktapeIO_Msg$SuggestionsSuccess(source_url),
		task);
};
var _user$project$DecktapeIO_Comms$submitUrl = function (presentationUrl) {
	var bodyObj = _elm_lang$core$Json_Encode$object(
		_elm_lang$core$Native_List.fromArray(
			[
				{
				ctor: '_Tuple2',
				_0: 'url',
				_1: _elm_lang$core$Json_Encode$string(presentationUrl)
			}
			]));
	var body = _evancz$elm_http$Http$string(
		A2(_elm_lang$core$Json_Encode$encode, 2, bodyObj));
	var url = A2(
		_evancz$elm_http$Http$url,
		'/convert',
		_elm_lang$core$Native_List.fromArray(
			[]));
	var task = A3(_evancz$elm_http$Http$post, _user$project$DecktapeIO_Json$convertDecoder, url, body);
	return A3(
		_elm_lang$core$Task$perform,
		function (_p1) {
			return A2(
				_user$project$DecktapeIO_Msg$SubmissionError,
				presentationUrl,
				_user$project$DecktapeIO_Json$errorToString(_p1));
		},
		_user$project$DecktapeIO_Msg$SubmissionSuccess(presentationUrl),
		task);
};

var _user$project$DecktapeIO_Polling$statusPoller = F2(
	function (statusURL, fileID) {
		var decoder = A2(_user$project$DecktapeIO_Json$statusDecoder, fileID, statusURL);
		var $continue = function (convDetails) {
			var _p0 = convDetails;
			switch (_p0.ctor) {
				case 'Complete':
					return false;
		...
		return A6(
			_sixty_north$elm_task_repeater$TaskRepeater$model,
			A2(_evancz$elm_http$Http$get, decoder, statusURL),
			_sixty_north$elm_task_repeater$TaskRepeater_Schedulers$uniform(_elm_lang$core$Time$second * 2),
			_user$project$DecktapeIO_Msg$StatusSuccess(fileID),
			function (_p1) {
				return A2(
					_user$project$DecktapeIO_Msg$StatusError,
					fileID,
					_user$project$DecktapeIO_Json$errorToString(_p1));
			},
			_user$project$DecktapeIO_Msg$Poll(fileID),
			$continue);
	});
var _user$project$DecktapeIO_Polling$update = F3(
	function (fileID, msg, pollers) {
		var _p2 = A2(_elm_lang$core$Dict$get, fileID, pollers);
		if (_p2.ctor === 'Just') {
			return function (_p3) {
				var _p4 = _p3;
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					A3(_elm_lang$core$Dict$insert, fileID, _p4._0, pollers),
					_elm_lang$core$Native_List.fromArray(
						[_p4._1]));
			}(
				A2(_sixty_north$elm_task_repeater$TaskRepeater$update, msg, _p2._0));
		} else {
			return A2(
				_elm_lang$core$Platform_Cmd_ops['!'],
				pollers,
...
var _user$project$DecktapeIO_Model$initialModel = {
	current_url: '',
	conversions: _elm_lang$core$Native_List.fromArray(
		[]),
	suggestions: _elm_lang$core$Native_List.fromArray(
		[]),
	mdl: _debois$elm_mdl$Material$model,
	pollers: _elm_lang$core$Dict$empty
};
var _user$project$DecktapeIO_Model$pollers = A2(
	_arturopala$elm_monocle$Monocle_Lens$Lens,
	function (_) {
		return _.pollers;
	},
...
var _user$project$DecktapeIO_Model$suggestions = A2(
	_arturopala$elm_monocle$Monocle_Lens$Lens,
	function (_) {
...
var _user$project$DecktapeIO_Model$conversions = A2(
	_arturopala$elm_monocle$Monocle_Lens$Lens,
	function (_) {
		return _.conversions;
	},
	F2(
		function (c, m) {
			return _elm_lang$core$Native_Utils.update(
...
var _user$project$DecktapeIO_Model$current_url = A2(
	_arturopala$elm_monocle$Monocle_Lens$Lens,
	function (_) {
		return _.current_url;
	},
	F2(
		function (u, m) {
			return _elm_lang$core$Native_Utils.update(
...
var _user$project$DecktapeIO_Model$Model = F5(
	function (a, b, c, d, e) {
		return {current_url: a, conversions: b, suggestions: c, mdl: d, pollers: e};
	});

var _user$project$DecktapeIO_Update$handleSetCurrentUrl = function (url) {
	return function (_p0) {
		return ((_elm_lang$core$Native_Utils.cmp(
			_elm_lang$core$String$length(url),
			5) < 0) ? _Fresheyeball$elm_return$Return$map(
			_user$project$DecktapeIO_Model$suggestions.set(
				_elm_lang$core$Native_List.fromArray(
					[]))) : _Fresheyeball$elm_return$Return$command(
			_user$project$DecktapeIO_Comms$getSuggestions(url)))(
			A2(
				_Fresheyeball$elm_return$Return$map,
				_user$project$DecktapeIO_Model$current_url.set(url),
				_p0));
	};
};
var _user$project$DecktapeIO_Update$updateDetails = F3(
	function (details, file_id, conv) {
		var new_details = function () {
			var _p1 = conv.details;
			switch (_p1.ctor) {
				case 'Initiated':
					return _elm_lang$core$Native_Utils.eq(_p1._0.file_id, file_id) ? details : conv.details;
				case 'InProgress':
					return _elm_lang$core$Native_Utils.eq(_p1._0.locator.file_id, file_id) ? details : conv.details;
				case 'Complete':
					return _elm_lang$core$Native_Utils.eq(_p1._0.locator.file_id, file_id) ? details : conv.details;
				default:
					return conv.details;
...
var _user$project$DecktapeIO_Update$statusDetails = function (result) {
	var _p2 = result;
	if (_p2.ctor === 'Err') {
		return _user$project$DecktapeIO_Types$Error(_p2._0);
	} else {
		return _p2._0;
	}
};
var _user$project$DecktapeIO_Update$inPlace = F3(
	function (lens, f, model) {
		var val = f(
			lens.get(model));
		return A2(lens.set, val, model);
	});
var _user$project$DecktapeIO_Update$handleSubmissionSuccess = F2(
	function (locator, source_url) {
		var poller = A2(_user$project$DecktapeIO_Polling$statusPoller, locator.file_id, locator.status_url);
		var conversion = A2(
			_user$project$DecktapeIO_Types$Conversion,
			source_url,
			_user$project$DecktapeIO_Types$Initiated(locator));
		return function (_p3) {
			return A2(
				_Fresheyeball$elm_return$Return$command,
				_sixty_north$elm_task_repeater$TaskRepeater$start(poller),
				A2(
					_Fresheyeball$elm_return$Return$map,
					A2(
						_user$project$DecktapeIO_Update$inPlace,
						_user$project$DecktapeIO_Model$pollers,
						A2(_elm_lang$core$Dict$insert, locator.file_id, poller)),
					A2(
						_Fresheyeball$elm_return$Return$map,
						A2(
							_user$project$DecktapeIO_Update$inPlace,
							_user$project$DecktapeIO_Model$conversions,
							F2(
								function (x, y) {
									return A2(_elm_lang$core$List_ops['::'], x, y);
								})(conversion)),
...
var _user$project$DecktapeIO_Update$handleSubmissionError = F2(
	function (msg, source_url) {
		var conversion = A2(
			_user$project$DecktapeIO_Types$Conversion,
			source_url,
			_user$project$DecktapeIO_Types$Error(msg));
...
var _user$project$DecktapeIO_Update$handleStatus_ = F3(
	function (removePoller, details, fileId) {
		var updatePollers = function (p) {
			return removePoller ? A2(_elm_lang$core$Dict$remove, fileId, p) : p;
		};
		var conversionUpdater = A2(_user$project$DecktapeIO_Update$updateDetails, details, fileId);
		return function (_p4) {
			return A2(
				_Fresheyeball$elm_return$Return$map,
				A2(_user$project$DecktapeIO_Update$inPlace, _user$project$DecktapeIO_Model$pollers, updatePollers),
				A2(
					_Fresheyeball$elm_return$Return$map,
					A2(
						_user$project$DecktapeIO_Update$inPlace,
						_user$project$DecktapeIO_Model$conversions,
						_elm_lang$core$List$map(conversionUpdater)),
					_p4));
		};
	});
var _user$project$DecktapeIO_Update$handleStatusSuccess = function (details) {
	var removePoller = function () {
		var _p5 = details;
		if (_p5.ctor === 'Complete') {
			return true;
		} else {
			return false;
		}
	}();
	return A2(_user$project$DecktapeIO_Update$handleStatus_, removePoller, details);
};
var _user$project$DecktapeIO_Update$handleStatusError = function (_p6) {
	return A2(
		_user$project$DecktapeIO_Update$handleStatus_,
		false,
		_user$project$DecktapeIO_Types$Error(_p6));
};
var _user$project$DecktapeIO_Update$update = F2(
	function (msg, model) {
		return function () {
			var _p7 = msg;
			switch (_p7.ctor) {
				case 'SetCurrentUrl':
					return _user$project$DecktapeIO_Update$handleSetCurrentUrl(_p7._0);
				case 'SubmitCurrentUrl':
					return function (_p8) {
						return A2(
							_Fresheyeball$elm_return$Return$command,
							_user$project$DecktapeIO_Comms$submitUrl(model.current_url),
							A2(
								_Fresheyeball$elm_return$Return$command,
								_shmookey$cmd_extra$Cmd_Extra$message(
									_user$project$DecktapeIO_Msg$SetCurrentUrl('')),
								_p8));
					};
				case 'SubmissionSuccess':
					return A2(_user$project$DecktapeIO_Update$handleSubmissionSuccess, _p7._1, _p7._0);
				case 'SubmissionError':
					return A2(_user$project$DecktapeIO_Update$handleSubmissionError, _p7._1, _p7._0);
				case 'StatusSuccess':
					return A2(_user$project$DecktapeIO_Update$handleStatusSuccess, _p7._1, _p7._0);
				case 'StatusError':
					return A2(_user$project$DecktapeIO_Update$handleStatusError, _p7._1, _p7._0);
				case 'SuggestionsSuccess':
					return _Fresheyeball$elm_return$Return$map(
						_user$project$DecktapeIO_Model$suggestions.set(_p7._1));
				case 'SuggestionsError':
					return _Fresheyeball$elm_return$Return$zero;
				case 'Mdl':
					return function (_p9) {
						var _p10 = _p9;
						return A2(_debois$elm_mdl$Material$update, _p7._0, _p10._0);
					};
				default:
					return A3(
						_toastal$return_optics$Return_Optics$refractl,
						_user$project$DecktapeIO_Model$pollers,
						_elm_lang$core$Basics$identity,
						A2(_user$project$DecktapeIO_Polling$update, _p7._0, _p7._1));
			}
		}()(
...
var Elm = {};
Elm['DecktapeIO'] = Elm['DecktapeIO'] || {};
Elm['DecktapeIO']['Update'] = Elm['DecktapeIO']['Update'] || {};
_elm_lang$core$Native_Platform.addPublicModule(Elm['DecktapeIO']['Update'], 'DecktapeIO.Update', typeof _user$project$DecktapeIO_Update$main === 'undefined' ? null : _user$project$DecktapeIO_Update$main);
